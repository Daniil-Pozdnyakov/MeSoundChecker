...
3. Open project folder and **change code, where have comments # in "main.py"** (You can open that with TextEdit. Use right mouse button and select "Open With" > TextEdit)
